...
echo ""
echo "Provjera:"
echo "  curl http://localhost:$USER_SERVICE_PORT/actuator/health"
echo "  curl http://localhost:$RESOURCE_SERVICE_PORT/actuator/health"
echo "  curl http://localhost:$BOOKING_SERVICE_PORT/actuator/health"
echo "  curl http://localhost:$PAYMENT_SERVICE_PORT/actuator/health"
echo ""
echo "Logovi:"
